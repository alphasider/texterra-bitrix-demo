$(document).ready(() => {
  ...
  (e = window).URLSearchParams = e.URLSearchParams || function (e) {
    ...
    scrollStatus()
  }), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? $("#wehelp .service").addClass("touch") : $("#wehelp .service").addClass("notouch"), $(".navblock .backbtn, .headoverlay").on("click", () => {
    $(".navblock").removeClass("vis")
  }), $("[data-call]").on("click", e => {
    $("html, body").addClass("fix");
    let a = $(e.currentTarget).data("call");
    $(`#overlay, [data-pp="${a}"]`).fadeIn()
  }), $("[data-service]").on("click", e => {
    let a = $(e.currentTarget).parents(".service").find(".caption").text().toLowerCase();
    $('[data-pp="order"] [data-servicename]').val("Ведение " + a)
  }), $(".modal .close, .modal [data-close], #overlay").on("click", () => {
    $('[data-pp="order"] [data-servicename]').val(""), $("#overlay, [data-pp]").fadeOut(), $("html, body").removeClass("fix")
  }), $("a.toankor").click(e => {
    var a = $(e.currentTarget).attr("href"), t = $(a).offset();
    $(".navblock").removeClass("vis"), $("html, body").animate({scrollTop: t.top - 100}, 700)
  }), whyTab(".whytabs .tabitem:first-of-type"), $(".whytabs .tabitem").on("click", e => {
    whyTab(e.currentTarget)
  }), $(".tarifftabs .tabitem").on("click", e => {
  ...
  let a = new URLSearchParams(window.location.search).get("slide"),
  ...
  a = a ? t.indexOf(document.querySelector("#" + a)) : 0, setTimeout((function () {
    new Swiper("#first .swiper-container", {
      ...
      autoHeight: !0,
      loop: !0,
      pagination: {el: "#first .swiper-pagination", type: "bullets", clickable: !0}
    })
  }), 10);
  new Swiper("#reviews .swiper-container", {
    ...
    breakpoints: {768: {slidesPerView: 2, spaceBetween: 20}, 1200: {slidesPerView: 3, spaceBetween: 40}}
  }), new Swiper("#partners .swiper-container", {
    slidesPerView: 1,
    loop: !1,
    spaceBetween: 40,
    navigation: {nextEl: "#partners .swiper-button-next", prevEl: "#partners .swiper-button-prev"},
    breakpoints: {
